...
pub trait Score<const R: usize, const C: usize> {
	fn score_layout_position_sequence(&self, layout: &Layout<R, C>, effort_layer: &Layer<R, C, f32>, layout_position_sequence: LayoutPositionSequence, config: &LayoutOptimizerConfig) -> f32;
}
